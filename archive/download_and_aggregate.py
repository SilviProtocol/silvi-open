#!/usr/bin/env python3
"""
DOWNLOAD AND AGGREGATE ONLY

Use this when GEE task is already complete.
Skips extraction - just downloads from Drive and aggregates to 256D signature.

Usage:
    python download_and_aggregate.py "Acer rubrum"
"""
...
def main():
    """Main execution"""
    if len(sys.argv) < 2:
        print("Usage: python download_and_aggregate.py <species_name>")
        print("\nExample:")
        print("  python download_and_aggregate.py 'Acer rubrum'")
        sys.exit(1)

    species_name = sys.argv[1]

    print("="*70)
    print("DOWNLOAD AND AGGREGATE")
    print("="*70)
    print(f"\nSpecies: {species_name}")
